...
from app.core.deps import get_coros, get_agent
...
def seed_fitness_data(auth_client):
    ...
    today = date.today()
    records = [
      FitnessData(user_id=user_id, date=today - timedelta(days=1), data_type='daily_metrics',
                  data='{"training_load": 50, "avg_sleep_hrv": 60, "rhr": 55}'),
      FitnessData(user_id=user_id, date=today - timedelta(days=2), data_type='daily_metrics',
                  data='{"training_load": 55, "avg_sleep_hrv": 58, "rhr": 56}'),
      FitnessData(user_id=user_id, date=today - timedelta(days=3), data_type='daily_metrics',
